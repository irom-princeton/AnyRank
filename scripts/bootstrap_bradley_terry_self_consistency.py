...
if __name__ == "__main__":
    ...
    results_dict["n_bootstrap"] = n_bootstrap
    results_dict["outcome_variance"] = variance_multiplier
    results_dict["n_hypotheses"] = n_hypotheses
    results_dict["alpha"] = desired_alpha
    ...
    for i in range(n_teams):
        ...
        results_dict[policy_std_args[i]] = std[i]
    ...
    with open(f"outputs/bootstrap_bt_consistency/npolicy_{n_teams}_npairs_{n_games}_nredraws_{n_reruns}.json", "w") as file:
